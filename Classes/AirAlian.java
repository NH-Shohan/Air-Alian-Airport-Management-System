...
//Final Class
public final class AirAlian {

    // Final Method
    public final void AirAlian1() {
        ...
        Airport A = new Airport(); // Association

        double balance = 500000;
        double[] m = new double[10]; // Array
        double TA = 0;
        double TM = 0;
                                            ...
                                            switch (n2) {
                                                ...
                                                case 3:
                                                    ...
                                                    System.out.println(
                                                            "\t\t!    Your Current Balance is : " + balance + " $");
                                                    System.out
                                                            .println("\t\t!    You have paid amount    : " + TA + " $");
                                                    System.out
                                                            .println("\t\t!    Returned Amount to You  : " + TM + " $");
                                                    System.out.println("\t\t--------------------------------------");
                                                ...
                                                default:
                                                    System.out.println(
                                                            "Your have Entered invalid number. Please try again.");
                                                    break;
                                            }
                                        }
                                        break;
                                            ...
                                            switch (n2) {
                                                ...
                                                case 2:
                                                    ...
                                                    if (balance == 5000) {
                                                        ...
                                                        TM += m[k];
                                                        System.out.println("\n\tYour " + m[k]
                                                                + " money has been returned. Thank You.");
                                                        System.out.println(
                                                                "\n\tYour Current balance is : " + balance + " $");
                                                    }
                                                    break;
                            ...
                            case 1:
                                ...
                                for (int i = 0; i < x; i++) {
                                    ...
                                    if (A.AddPassenger(P1)) {
                                        System.out.println("\nCode with " + P1.getCodeName()
                                                + " Passenger is Added Successfully.");
                                    } else {
                            ...
                            case 2:
                                ...
                                if (P2 != null) {
                                    if (A.RemovePassenger(P2)) {
                                        System.out.println("\nPassenger with Code " + P2.getCodeName()
                                                + " is removed Successfully.\n");
                                    } else {
                                        System.out.println("\nSorry. The Passenger can not be Removed.");
                                    }
                                } else {
                                    System.out.println("\nSorry. The Passenger Does Not Exist.");
                                }
                                break;
